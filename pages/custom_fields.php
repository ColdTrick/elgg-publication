...
switch ($type) {
	...
	case "article_journal":
		...
		$custom_field .= elgg_view('input/text', ['name' => 'journaltitle', 'value' => $journaltitle]) . "</div>";

		$custom_field .= "<div><label>" . elgg_echo('publication:number') . "<span class='elgg-quiet mls'>$required_text</span></label><br/>";
		$custom_field .= elgg_view('input/text', ['name' => 'number', 'value' => $number]) . "</div>";
	...
	default:
		...
		$custom_field .= elgg_view('input/text', ['name' => 'pages', 'value' => $pages]) . "</div>";
